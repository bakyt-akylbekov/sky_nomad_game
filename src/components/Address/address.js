                    ...
                    <div className="col-6">
                        <div className="address__item">
                            ...
                            <p className="address__text">
                                Бизнес центр 79 премиум класса с гармоничным <br/>сочетанием исключительного стиля,
                                современной <br/>технологией, удобным размещением и <br/> максимально комфортным
                                условием для <br/> эффективной работы
                            </p>
